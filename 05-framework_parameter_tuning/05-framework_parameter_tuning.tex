...
\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-MS-def_params}\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-MS-opt_params}\\\hspace*{0.2in}(a)\hspace*{3.2in}(b)
...
\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-LJ-opt_params}\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-LJ-def_params}\\\hspace*{0.2in}(a)\hspace*{3.2in}(b)
...
\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-HI-def_params}\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-HI-opt_params}\\\hspace*{0.2in}(a)\hspace*{3.2in}(b)
...
\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-MS-opt_params}\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-MS-opt_clutter}\\\hspace*{0.2in}(a)\hspace*{3.2in}(b)
...
\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-LJ-def_params}\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-LJ-opt_clutter}\\\hspace*{0.2in}(a)\hspace*{3.2in}(b)
...
\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-HI-opt_params}\includegraphics[width=0.47\textwidth]{\lyxdot \lyxdot /tun_par/doc/img/error_distribution-HI-opt_clutter}\\\hspace*{0.2in}(a)\hspace*{3.2in}(b)
