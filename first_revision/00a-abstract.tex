...
raèunalnika kot pomo¾no orodje za izvajanje hitrej¹ih in natanènih
...
Poizkusi v radijskih omre¾jih se izvajajo z modeliranjem radijskih
omre¾ij in simulacijami, vendar imajo veè pomanjkljivosti v zvezi
s ponujeno fleksibilnostjo in s èasom izvajanja simulacije. Velikost
omre¾ij, ki jih je mogoèe analizirati na izvedljivem èasu, je obièajno
zelo omejena.
...
podaja in primerja metode vzporednega raèunanja tako za izvajaje simulacij
na veèjedrnih procesorjih kot na gruèi raèunalnikov z grafiènimi procesorji,
ki so povezani preko lokalnega omre¾ja. Poveèana hitrost izvajanja
omogoèa poveèano stopnjo podrobnosti simulacij, kar posledièno izbolj¹uje
natanènost rezultatov.
...
Predlagani pristopi so preizku¹eni na kompleksnih optimizacijskih
problemih, in sicer (i) problem optimizacije ravnovesja povezave navzdol-navzgor
pri mehkem izroèanju v sistemih tretje generacije in (ii) optimizacija
parametrov empiriènih modelov raz¹irjanja radijskega valovanja. 

Problem optimizacije ravnovesja povezave navzdol-navzgor pri mehkem
izroèanju v sistemih tretje generacije je problem, ki se ga zaveda
veèina mobilnih operaterjev, vendar do sedaj zaradi svoje kompleksnosti
¹e ni bil re¹en. Prièujoèa disertacija formalno opredeljuje ta optimizacijski
problem ter prika¾e re¹itev problema po principu èrne ¹katle (angl.
black box) z uporabo razliènih metahevristiènih algoritmov. Rezultati
uporabe predlaganih metod poka¾ejo precej¹nje izbolj¹ane razporeditve
podroèij mehkega izroèanja.
...
izraèunane predikcije.

Predlagani pristopi na eni strani omogoèajo bolj podrobno analizo
omre¾ij v sprejemljivem èasu, po drugi strani pa z njimi lahko optimiziramo
